...
export const cardapio = [
  // Esfihas Salgadas
  { id: 1, nome: 'Carne',               preco: 5.15, descricao: 'Carne moída temperada com cebola e tomate.',        imagem: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=200', categoria: 'esfihas',    subcategoria: 'Salgadas', badge: 'Novo' },
  { id: 2, nome: 'Carne c/ Catupiry',   preco: 5.75, descricao: 'Carne moída com catupiry cremoso.',                 imagem: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=200', categoria: 'esfihas',    subcategoria: 'Salgadas', badge: 'Mais Pedido' },
  { id: 3, nome: 'Queijo',              preco: 4.50, descricao: 'Mussarela derretida com orégano fresco.',           imagem: 'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=200&q=80', categoria: 'esfihas',    subcategoria: 'Salgadas', badge: 'Mais pedido' },
  { id: 4, nome: 'Frango c/ Requeijão', preco: 5.50, descricao: 'Frango desfiado com requeijão cremoso.',            imagem: 'https://images.unsplash.com/photo-1482049016688-2d3e1b311543?w=200', categoria: 'esfihas',    subcategoria: 'Salgadas', badge: 'Favorito' },
  // Esfihas Doces
  ...
  // Cigarretes
  { id: 7, nome: 'Cigarrete de Carne',  preco: 6.50, descricao: 'Massa crocante recheada com carne temperada.',      imagem: 'https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=200', categoria: 'cigarretes', subcategoria: null, badge: 'Novo'       },
  ...
  { id: 11, nome: 'Limonada Suíça',     preco: 9.00, descricao: 'Limonada cremosa com limão siciliano.',             imagem: 'https://images.unsplash.com/photo-1523677011781-c91d1bbe2f9e?w=200', categoria: 'bebidas', destaque: true, badge: 'Novo'      },
  // Combos
  { id: 12, nome: 'Combo Família',      preco: 49.90, descricao: '10 esfihas à escolha + 2 refrigerantes lata.',     imagem: 'https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=200', categoria: 'combos',     subcategoria: null, badge: 'Oferta'       },
